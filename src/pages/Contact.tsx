      ...
      <div className="flex-grow flex items-center justify-center p-4 sm:p-6 lg:p-8 mt-16">
        <div className="w-full max-w-4xl mx-auto">
          <header className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-slate-600 dark:text-slate-400">Let's build something amazing together.</p>
          </header>
          ...
          <main className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="flex flex-col justify-center">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mt-10 mb-4">Find me on</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  {status === 'error' && <p className="text-red-600 text-center mt-3">Failed to send message. Please try again.</p>}
                </div>
              </form>
            </div>
          </main>
